...
export function LoginForm() {
  ...
  return (
    <div className="w-full max-w-md rounded-sm border border-slate-200 bg-white p-8 shadow-sm">
      ...
      <div className="mb-6 rounded-sm border border-emerald-200 bg-emerald-50 px-3 py-2">
        <p className="text-xs text-emerald-900 font-mono">
          Dev quick login: <span className="font-semibold">admin@noemail.com</span> /{" "}
      ...
      <form className="space-y-5" onSubmit={onSubmit}>
        ...
        >
          {loading ? (redirecting ? "Loading dashboard…" : "Signing in…") : "Sign in"}
        </Button>
      </form>
    </div>
  );
